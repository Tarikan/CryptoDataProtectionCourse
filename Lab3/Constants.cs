...
{
    public static readonly int[] InitialPermutationTable =
    {
    ...
    public static readonly int[] ReverseInitialPermutationTable =
    {
    ...
    public static readonly uint[] FirstKeyPermutationTableFirstPart =
    {
        56, 48, 40, 32, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35
    };

    public static readonly uint[] FirstKeyPermutationTableSecondPart =
    {
        62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 60, 52, 44, 36, 28, 20, 12, 4, 27, 19, 11, 3
    };

    public static readonly uint[] SecondKeyPermutationTable =
    {
    ...
    public static readonly int[] ExpansionTable =
    ...
    public static readonly int[] StraightPermutationTable =
    {
        15, 6, 19, 20, 28, 11, 27, 16, 0, 14, 22, 25, 4, 17, 30, 9, 1, 7, 23, 13, 31, 26, 2, 8, 18, 12, 29, 5, 21, 10, 3, 24
    };

    public static readonly uint[] ShiftBits = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};
